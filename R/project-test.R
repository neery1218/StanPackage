...
#' @param x A real number.
#' @return A real number between 0 and 2.
...
#' Log Posterior of test function.
#'
#' Log posterior of given observations.
#' @param mu Mean of the observations.
#' @param y Vector of observations.
#' @return A scalar of containing log posterior evaluated at its arguments.
#' @export
...
#' Gradient of the Log Posterior of test function.
#'
#' Gradient of the log posterior of given observations.
#' @param mu Mean of the observations.
#' @param y Vector of observations.
#' @return A scalar of containing gradient of the log posterior evaluated at its arguments.
#' @export
...
#' @return A vector of autocorrelations based on the arguments
#' @export
