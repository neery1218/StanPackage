...
namespace model_foo_dist_namespace {
using std::istream;
using std::string;
...
private:
        ...
        int type;
public:
    model_foo_dist(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_foo_dist_namespace::model_foo_dist";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_foo_dist_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_foo_dist_namespace::model_foo_dist stan_model;
#endif
