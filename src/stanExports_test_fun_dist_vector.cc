...
#include "stanExports_test_fun_dist_vector.h"

RCPP_MODULE(stan_fit4test_fun_dist_vector_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_test_fun_dist_vector")
