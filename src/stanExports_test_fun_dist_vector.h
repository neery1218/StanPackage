...
namespace model_test_fun_dist_vector_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_test_fun_dist_vector");
    reader.add_event(23, 21, "end", "model_test_fun_dist_vector");
    return reader;
}
...
class model_test_fun_dist_vector : public prob_grad {
private:
        int N;
public:
    model_test_fun_dist_vector(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_test_fun_dist_vector_namespace::model_test_fun_dist_vector";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_test_fun_dist_vector_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_test_fun_dist_vector";
    }
...
typedef model_test_fun_dist_vector_namespace::model_test_fun_dist_vector stan_model;
#endif
