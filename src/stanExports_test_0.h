...
namespace model_test_0_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_test_0");
    reader.add_event(20, 18, "end", "model_test_0");
    return reader;
}
...
class model_test_0 : public prob_grad {
private:
        int N;
        vector_d y;
public:
    model_test_0(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_test_0_namespace::model_test_0";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_test_0_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_test_0_namespace::model_test_0 stan_model;
#endif
